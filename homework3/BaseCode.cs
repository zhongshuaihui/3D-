...
namespace Com.Mygame
{
    ...
    public class movement
    {
        ...
        public static bool notmoving = false;
    }
    ...
    {
        void singlemoving(GameObject source, Vector3 target, float speed);
        void groupmoving(GameObject source, Vector3[] target, float[] speed);
    }
    ...
    public class mainController : System.Object, UserActions,GameJudge
    {
        ...
        public bool isGameObjectMoving;
